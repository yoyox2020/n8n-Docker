...
export declare class CheckerChildProcessProxy implements CheckerResource, Disposable, Resource {
    ...
    constructor(options: StrykerOptions, fileDescriptions: FileDescriptions, pluginModulePaths: readonly string[], loggingServerAddress: LoggingServerAddress, getLogger: LoggerFactoryMethod, idGenerator: IdGenerator);
