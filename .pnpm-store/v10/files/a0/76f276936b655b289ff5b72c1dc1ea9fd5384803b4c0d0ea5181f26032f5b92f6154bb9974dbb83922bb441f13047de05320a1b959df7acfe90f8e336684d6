...
export class BroadcastReporter {
    ...
    log;
    reporterOverride;
    static inject = tokens(commonTokens.options, coreTokens.pluginCreator, commonTokens.logger, coreTokens.reporterOverride);
    reporters;
    constructor(options, pluginCreator, log, reporterOverride) {
